...
class Model {
  ...
  constructor(values = {}, options = {}) {
    options = Object.assign({
      ...
      _dataBaseName: this.constructor._dataBaseName
    }, options || {});
  ...
  static init(attributes, options = {}) {
    ...
    this._dataBaseName = this.options.dataBaseName;
   ...
   */
  static describe(schema, options, dataBaseName) {
    return this.QueryInterface.describeTable(this.tableName, Object.assign({ schema: schema || this._schema || undefined, dataBaseName: dataBaseName || this._dataBaseName || undefined }, options));
  }
